  ...
  <div class="list">
    <div class="list-wrapper">
      ...
      <div class="list-container clearfix">
        <div class="newlist-list-container fl">
          <p class="new-list-title"><i></i>最新发现疑似僵尸企业</p>
          ...
          <div class="list-list">
            <ul class="list-top">
              ...
              <li class="sweep-time-col fl">扫描时间</li>
            </ul>
                ...
                <li class="clearfix" v-for="item in listData">
                  <div class="industry-col fl clearfix">
                    ...
                    <div class="industry-info fl">
                      <h1 @click="gotoDetails(item)" :id="item.entId" :title="item.name">{{item.name}}</h1>
                  ...
                  <div class="sweep-time-col fl"><span class="sweep-time">{{item.time}}</span></div>
                </li>
              </ul>
...
.new-list-title {
  ...
  i {
    ...
    height: 15px;
    margin-right: 6px;
    background: -webkit-linear-gradient(top,#39a9ff,#0072ff);
  }
}
</style>
<style lang="scss">
